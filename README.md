...
整体呈现**几何线图、结构主线、小尺度主体、大面积留白、少量彩色笔触与安静图文混排**共同构成的视觉效果，像独立出版物中的 spot illustration、概念页或图解式艺术插画：轻盈、理性、敏锐、克制而有余韵。避免完整场景、写实转绘、背景填满、无逻辑散点、粗黑轮廓、卡通感、矢量模板感、3D感和装饰堆砌。
